// Source Code from https://github.com/xyzzer/WinRTXamlToolkit/blob/master/WinRTXamlToolkit/Controls/WrapPanel/WrapPanel.cs
    ...
    public class WrapPanel : Panel
    {
        ...
        private static void OnOrientationPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                (value != Orientation.Vertical))
            {
                ...
                throw new ArgumentException("Properties.Resources.WrapPanel_OnOrientationPropertyChanged_InvalidValue", "value");
            }
        ...
        private static void OnItemHeightOrWidthPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!double.IsNaN(value) && ((value <= 0.0) || double.IsPositiveInfinity(value)))
            {
                ...
                throw new ArgumentException("Properties.Resources.WrapPanel_OnItemHeightOrWidthPropertyChanged_InvalidValue", "value");
            }
